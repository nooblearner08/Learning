    ...
    <section className="home">
      <div className="hero">
        <div className="leftSide">
          <h1>Top Professional Coders</h1>
          <p>
          Your premier destination for connecting with elite developers worldwide, offering a curated platform for collaboration, learning, and showcasing cutting-edge expertise.
          </p>
      ...
      <div className="footer">
        <div className="parentFooter">
          <div className="box11">
            <div className="logo">
              <h1 onClick={() => navigate("/")}>TPC</h1>
              <p>Top Professional Coders</p>
            </div>
            <p>+910945657</p>
          </div>
          <div className="box12">
        ...
        <div className="childFooter">
          <h4>Copyright © 2024 TPC (Top Professional Coders) All rights reserved</h4>
